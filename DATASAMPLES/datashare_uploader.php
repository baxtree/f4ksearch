<?php
	...
	foreach (glob($all_year_csv . "/*.csv") as $videofile) {
		$itemname = explode(".",  basename($videofile));
		$csvfile = $all_year_csv . "/" . $itemname[0] . ".csv";
...
/*             $ds_dr->toString(); */
	...
	foreach (glob($full_day_csv . "/*.csv") as $videofile) {
		$itemname = explode(".",  basename($videofile));
		$csvfile = $full_day_csv . "/" . $itemname[0] . ".csv";
